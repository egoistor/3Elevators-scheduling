...
{
	char case1[] = "D:\input.txt";
	char case2[] = "D:\output1.txt";
	char case3[] = "D:\output2.txt";
	char case4[] = "D:\output3.txt";
	if (argc == 1 && (strcmp(argv[0], case1)) == 1)
	{
		ofstream outfile1("./output1.txt", ios::app);
		ofstream outfile2("./output2.txt", ios::app);
		ofstream outfile3("./output3.txt", ios::app);
	}
	if (argc == 4 && (strcmp(argv[0], case1) == 1) && (strcmp(argv[1], case2) == 1)&& (strcmp(argv[2], case3) == 1)&& (strcmp(argv[3], case4) == 1))
	{
		ofstream outfile1("./output1.txt", ios::app);
		ofstream outfile2("./output2.txt", ios::app);
		ofstream outfile3("./output3.txt", ios::app);
